...
public class ReportView {
    ...
    public BorderPane create() {
        ...
        Label description = new Label("Buat laporan keuangan, persediaan, dan penjualan.");
        description.setStyle("""
                -fx-font-size: 13px;
                -fx-text-fill: #64748B;
                """);

        Button generate = new Button("Generate Laporan");
        generate.setStyle("""
        ...
        topBar.getChildren().addAll(spacer, generate);

        Label placeholder = new Label("Pilih jenis laporan dan periode untuk menghasilkan laporan.");
